...
namespace Zora.Shared.Domain.Models
{
    public static class Guard
    {
        ...
        public static void AgainstInvalidDateRange<TException>(DateTime startDate, DateTime endDate, string name = "Value")
         where TException : BaseDomainException, new()
        {
            ...
            ThrowException<TException>($"{name} must be greater than {startDate}");
        }
